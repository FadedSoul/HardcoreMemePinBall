...
* grebruik floats inplaats van ints
...
Score
{
	Moet aanroepbaar vanuit andere classes zijn(get set)
}
...
3d moddels
{
	maak de model voor de trekker,pickup,trekker
	maak goede flippers
}

universele next scene code
{
	maak het zo dat het kan gebruikt worden door andere classes en niet alleen met een button ook death en stuff.
}
